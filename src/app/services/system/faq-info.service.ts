...
export class FaqInfoService {
  ...
  getAllFaqInfos(): Observable<FaqInfo[]> {
    return this.http
      .get<FaqInfo[]>(`${this.url}/h?dt=faq&status=all`)
      .pipe(
        catchError(
          this.handleHttpErrorService.handleError<FaqInfo[]>(
            'FaqInfoService.getAllFaqInfos'
          )
        )
      );
  }
  ...
  getActivatedFaqInfos(): Observable<FaqInfo[]> {
    return this.http
      .get<FaqInfo[]>(`${this.url}/h?dt=faq&status=1`)
      .pipe(
        catchError(
          this.handleHttpErrorService.handleError<FaqInfo[]>(
            'FaqInfoService.getActivatedFaqInfos'
          )
        )
      );
  }
  ...
  getFaqInfo(id: number): Observable<FaqInfo> {
    return this.http
      .get<FaqInfo>(`${this.url}/h/${id}?dt=faq`)
      .pipe(
        catchError(
          this.handleHttpErrorService.handleError<FaqInfo>(
            'FaqInfoService.getFaqInfo'
          )
        )
      );
  }
  ...
  updateFaqInfo(faqInfo: FaqInfo): Observable<any> {
    return this.http
      .put<number>(`${this.url}/h?dt=faq`, faqInfo, this.httpOptions)
      .pipe(
        catchError(
          this.handleHttpErrorService.handleError<number>(
            'FaqInfoService.updateFaqInfoo'
          )
        )
      );
  }
  ...
  addFaqInfo(faqInfo: FaqInfo): Observable<number> {
    return this.http
      .post<number>(`${this.url}/h?dt=faq`, faqInfo, this.httpOptions)
      .pipe(
        catchError(
          this.handleHttpErrorService.handleError<number>(
            'FaqInfoService.addFaqInfo'
          )
        )
      );
  }
  ...
  deleteFaqInfo(id: number): Observable<number> {
    return this.http
      .delete<number>(`${this.url}/h/${id}?dt=faq`, this.httpOptions)
      .pipe(
        catchError(
          this.handleHttpErrorService.handleError<number>(
            'FaqInfoService.deleteFaqInfo'
          )
        )
      );
  }
